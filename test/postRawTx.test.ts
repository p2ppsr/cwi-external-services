...
describe("postRawTx.test", () => {
    ...
    test('postRawTx already mined testnet', async () => {
        ...
        // Invalid api keys
        options.mainTaalApiKey = "mainnet_a596de07e92300c6287e4393594ae39c"
        options.testTaalApiKey = "testnet_0e6cf72133b43ea2d7861da2a38684e3"

        const svcs = new CwiExternalServices(options)
        const rawTx = ''
        const r = await svcs.postRawTx(rawTx, 'test', undefined)
        expect(r[1].status).toBe('error')
        const name = r[1].error?.name
